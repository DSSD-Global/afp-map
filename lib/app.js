"use ./config.js";
//country names mapped to lat/lon and ISO3 codes
var country = {
  ...
  "Bonaire, Saint Eustatius and Saba": [[17.62590935, -63.2462886305583], "BES"],
  ...
  "British Indian Ocean Territory": [[-5.349626649999999, 72.00648804312836], "IOT"],
  ...
  "French Southern Territories": [[-49.237441950000004, 69.62275903679347], "ATF"],
  ...
  "Svalbard and Jan Mayen Islands": [[78.4903547137402, 18.1484913825989], "SJM"],
...
//ISO3 codes mapped to lat/lon and country names
var iso = {
  ...
  "IOT": [[-5.349626649999999, 72.00648804312836], "British Indian Ocean Territory"],
  ...
  "ATF": [[-49.237441950000004, 69.62275903679347], "French Southern Territories"],
...
//mapping of database values to gsx values
var gsxToEnglish = {
...
function organizeData(data) {
  ...
  for (var i = 1; i < entries.length; i++) {
    ...
    keys.forEach((key, index) => {
      if (key.includes("gsx$")) {
        //store new org titles with empty objects to hold their data
        if (key === "gsx$_cokwr") {
          orgName = entry[key]["$t"]; 
          toRet[orgName] = {}; 
        }
...
//attempt to load organizations from the database
