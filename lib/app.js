...
L.Control.Checkboxes = L.Control.extend({
  onAdd: function (map) {
    ...
    boxes += "</div>";
    div.innerHTML =
      "<div class=t id ='box_control'><img src=https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Hamburger_icon.svg/1200px-Hamburger_icon.svg.png width='30px', height ='30px'></img></div>";
